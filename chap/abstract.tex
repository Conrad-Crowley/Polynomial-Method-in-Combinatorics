\begin{abstract}
    ...
    In the latter problem we present a new proof for bounding the number of tangencies in a (non-degenerate) collection of  circles by $O(N^{3/2})$, utilising Guth's recent result of polynomial partitioning for varieties.
\end{abstract}