...
$\mathcal P_0$ is non-empty, as by the definition of $C_2$ it at least contains the partitioning polynomial $P$. Let us take the polynomial in $\mathcal P_0$ of minimal degree and label it $P_0$. \todo{expand on this maybe}Then $Z(\partial_z P_0)$ contains all the points of $I(C_2,C_2)$.  Either $\partial_z P_0 \equiv 0$ or it is not. 
