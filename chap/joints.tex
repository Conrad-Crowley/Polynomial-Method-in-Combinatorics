...
We denote this quantity $J(L)$. In other words $J(L)$ is the supremeum over all configurations of lines in $\RR^n$ in the number of joints. \todo{?}



\todo{examples corrections}
