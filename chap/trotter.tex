...
A function $f :\RR^n \to \RR$ is said to bisect an open set $U$ with volume\footnote{This is just the Lebesgue measure.} $\text{Vol}(U) < \infty$ if
\[
...
\begin{align*}
    ...
    \intertext{These two remaining terms are symmetrical, so we only need bound one of them. We continue to bound}
    &< 2 \varepsilon. 
\end{align*}
